...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'mahdimohamadi110@gmail.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'بامبو وب';
   ...
   * @var string
   */
  public $Sender            = 'mahdimohamadi110@gmail.com';

  /**
   * Sets the Subject of the message.
   * @var string
   */
  public $Subject           = 'این عنوان ایمیل است';
   ...
   * @var string
   */
  public $AltBody           = 'اگه ایمیل به درستی نمایش داده نمیشه';
  ...
  */
   ...
   * @var string
   */
  public $Username      = 'mahdimohamadi110@gmail.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'Mm@4270466162';
